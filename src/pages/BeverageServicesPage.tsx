    ...
    <div className="bg-white">
      ...
      <section className="relative h-[85vh] flex items-center justify-center">
        <div 
          ...
          style={{ backgroundImage: "url('https://i.postimg.cc/7ZW761mZ/drinks-vivid-2.png')" }}
        >
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-gray-200 max-w-2xl mx-auto">
            Premium drinks and signature mocktails to complement your event
          </p>
        </div>
      </section>
      ...
      <section className="py-10 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-8">
            ...
            <h2 className="font-serif text-3xl md:text-4xl font-bold text-gray-900">Complete Your Event with Premium Beverages</h2>
          </div>
          
          <div className="space-y-5 text-gray-600 text-lg leading-relaxed">
            <p>
              No event is complete without the perfect beverages to accompany the food. At Vivid Catering, our beverage services are designed to complement your culinary experience with refreshing drinks, artisan mocktails, and premium selections that delight every guest.
            </p>
            <p>
              From freshly squeezed juices to expertly crafted mocktails, our beverage menu is as thoughtfully curated as our food offerings. We use only the finest ingredients to create drinks that are as beautiful as they are delicious.
            </p>
            <p>
              Our professional bartenders and service staff ensure smooth beverage service throughout your event, keeping glasses filled and guests satisfied. Whether you need a simple coffee service or a full mocktail bar, we deliver excellence in every pour.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">Discuss your event needs and beverage preferences</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-lg text-gray-900 mb-2">Menu Curation</h3>
              <p className="text-gray-600 text-sm">We create a custom beverage menu for your event</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-lg text-gray-900 mb-2">Setup & Prep</h3>
              <p className="text-gray-600 text-sm">Our team sets up the bar and prepares all ingredients</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-lg text-gray-900 mb-2">Service Excellence</h3>
              <p className="text-gray-600 text-sm">Professional bartenders serve your guests all event long</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-10 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-8">
            ...
            <h2 className="font-serif text-3xl md:text-4xl font-bold text-gray-900">Beverage Gallery</h2>
          </div>
          
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            <div className="aspect-square rounded-xl overflow-hidden">
              <img src="https://images.unsplash.com/photo-1544145945-f90425340c7e?w=600" alt="Fresh Juices" className="w-full h-full object-cover hover:scale-110 transition-transform duration-500" />
            </div>
            <div className="aspect-square rounded-xl overflow-hidden">
              <img src="https://images.unsplash.com/photo-1582106245687-cbb466a9f07f?w=600" alt="Mocktails" className="w-full h-full object-cover hover:scale-110 transition-transform duration-500" />
            </div>
            <div className="aspect-square rounded-xl overflow-hidden">
              <img src="https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=600" alt="Coffee" className="w-full h-full object-cover hover:scale-110 transition-transform duration-500" />
            </div>
            <div className="aspect-square rounded-xl overflow-hidden">
              <img src="https://images.unsplash.com/photo-1556679343-c7306c1976bc?w=600" alt="Cocktail Bar" className="w-full h-full object-cover hover:scale-110 transition-transform duration-500" />
            </div>
            <div className="aspect-square rounded-xl overflow-hidden">
              <img src="https://images.unsplash.com/photo-1481671703460-040cb8a2d909?w=600" alt="Refreshments" className="w-full h-full object-cover hover:scale-110 transition-transform duration-500" />
            </div>
            <div className="aspect-square rounded-xl overflow-hidden">
              <img src="https://images.unsplash.com/photo-1551024709-8f23befc6f87?w=600" alt="Signature Drinks" className="w-full h-full object-cover hover:scale-110 transition-transform duration-500" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="font-serif text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            Ready to Add Premium Beverages to Your Event?
          </h2>
          <p className="text-gray-600 text-lg mb-8">
            Complete your catering experience with our exceptional beverage services.
          </p>
